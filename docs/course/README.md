...
> **Status:** 🟡 In progress. **Modules 0–3 shipped** (setup · bounded termination ·
> critique design · tracing). Modules 4–6 are outlined below and land over the following weeks.
