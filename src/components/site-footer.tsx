...
/**
 * Ecosystem footer — follows gemini/witus/public/brand/footer-recipe.md with the
 * Wanderlearn `sky` accent on slate (Wanderlearn's ecosystem accent per
 * gemini/witus/lib/products.ts). The Rise Wellness non-affiliation disclaimer is
 * reproduced byte-identical — only the app-name token differs — and must never
 * be paraphrased.
 */
...
const linkClasses =
  "inline-flex items-center min-h-7 text-slate-600 hover:text-sky-700 " +
  "hover:underline transition-colors focus:outline-none focus-visible:outline-2 " +
  "focus-visible:outline-offset-2 focus-visible:outline-sky-600 rounded " +
        ...
        <div className="mt-8 border-t border-slate-100 pt-6 text-center text-xs text-slate-500 dark:border-slate-800/60">
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-slate-600 hover:text-sky-700 hover:underline dark:text-slate-400"
            >
              AwesomeWebStore.com
              <span className="sr-only"> (opens in new tab)</span>
            </a>{" "}
...
/**
 * Rise Wellness callout. The container tone is the only swap; everything inside
 * — and especially the disclaimer — is canonical and verbatim from
 * gemini/witus/public/brand/footer-recipe.md.
 */
function RiseWellnessCallout() {
  return (
    <section
      aria-labelledby="rise-wellness-heading"
      className="mb-8 rounded-lg border border-sky-200 bg-sky-50/60 p-5 text-sm dark:border-sky-500/30 dark:bg-sky-500/10"
    >
        ...
        <div className="space-y-1">
          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 pt-2 text-xs">
            <a
              ...
              className="inline-flex min-h-7 items-center rounded font-medium text-sky-700 hover:underline focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 dark:text-sky-400"
            >
              317-965-0299
            </a>
      ...
      <blockquote className="mt-4 border-l-2 border-sky-300 pl-3 text-xs italic text-slate-600 dark:text-slate-400">
      ...
      <p className="mt-4 text-[11px] leading-relaxed text-slate-500">
        ...
        affiliated with, employed by, or endorsed by Wanderlearn Field Reporter,
